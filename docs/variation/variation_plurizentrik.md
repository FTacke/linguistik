...
Diese Vielfalt zeigt sich auf allen Ebenen: in der Aussprache, im Wortschatz, in grammatischen Strukturen und in typischen Redewendungen. Lautliche Unterschiede sind oft das erste, was Lernenden auffällt: Im größten Teil der spanischsprachigen Welt – fast ganz Hispanoamerika sowie Teile Spaniens – kennt das phonologische System keinen Interdentallaut, sodass *caza* und *casa* identisch als `[ˈkasa]` ausgesprochen werden; man spricht hier vom *seseo* (vgl. Kapitel [Variation in der Aussprache](./variation_aussprache.md)). Grammatikalische Unterschiede sind mitunter weniger sichtbar, aber ebenso grundlegend: In großen Teilen Hispanoamerikas ist *canté* die gewöhnliche Vergangenheitsform in Kontexten, in denen im kastilischen Spanisch *he cantado* steht, und *ustedes* übernimmt dort die Rolle von *vosotros* (vgl. Kapitel [Variation in der Grammatik](./variation_grammatik.md) und [Variation in der Anrede](./variation_anrede.md)).
...
|----------------|------------------|-------------------------------|
| **diatopische Variation** | regionale Unterschiede innerhalb einer Sprache | *ordenador* (Spanien) vs. *computadora* (Hispano&shy;amerika) |
...
??? oton "„Mi acento mexicano es parte de mi identidad como docente“"
...
- Tacke, Felix (2024b): „Informal Standardization and the Regionalization of Language Norms: An Introduction“, in: Tacke, Felix (Hg.): *Informal Standardization and the Regionalization of Language Norms.* *Energeia* 9, 1–17. DOI: 10.55245/energeia.2024.001.
