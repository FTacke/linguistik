...
??? hoermal "Hör mal: *Europa* – deutscher Transfer vs. spanische Zielaussprache"
    ...
    <source class="zc-audio-src" data-zc-src="assets/audiofiles/TODO_europa_l1.mp3" type="audio/mpeg">
    ...
    <audio controls preload="metadata">
    <source class="zc-audio-src" data-zc-src="assets/audiofiles/TODO_europa_ele.mp3" type="audio/mpeg">
    Dein Browser unterstützt das Audio-Format nicht.
    </audio>
    </div>
    </div>
